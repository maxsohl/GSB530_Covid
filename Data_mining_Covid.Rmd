---
title: "Data Mining Project - Covid Analysis"
...
model1 <- glm(Result ~ Cough + Fever + Sore_Throat + Shortness_Of_Breath + Headache + Age_60_And_Above + Contact , data = trainSet, family = binomial)
summary(model1)
